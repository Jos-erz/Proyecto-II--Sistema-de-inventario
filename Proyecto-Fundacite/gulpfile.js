...
//  [ copy html-folder assets (js/css/images alongside html pages) ] start
gulp.task('copy-html-assets', function () {
  return gulp
    .src(['src/html/**/*.js', 'src/html/**/*.css', 'src/html/**/*.webp', 'src/html/**/*.png', 'src/html/**/*.jpg', 'src/html/**/*.gif', 'src/html/**/*.svg'])
    .pipe(gulp.dest('dist'));
});
//  [ copy html-folder assets ] end
...
gulp.task('browserSync', function () {
  browsersync.init({
    ...
    startPath: '/Procesos/inicio_de_sesion/Login.html'
  });
});
//  [ browser reload ] end

// Solo borra las carpetas generadas por el build, sin tocar los archivos raíz de dist/
...
gulp.task('watch', function () {
  ...
  gulp.watch(
    ['src/html/**/*.js', 'src/html/**/*.css', 'src/html/**/*.webp', 'src/html/**/*.png', 'src/html/**/*.jpg', 'src/html/**/*.gif', 'src/html/**/*.svg'],
    gulp.series('copy-html-assets')
  ).on('change', browsersync.reload);
});
//  [ watch ] start
const compile = gulp.parallel('browserSync', 'watch');
//  [ Default task ] start
gulp.task('default', gulp.series('cleandist', 'build', 'sass', 'build-js', 'build-html', 'copy-html-assets', 'imgmin', compile));
//  [ Default task ] end
// build in production mode
gulp.task('build-prod', gulp.series('cleandist', 'build', 'sass', 'build-js', 'build-html', 'copy-html-assets', 'imgmin'));
